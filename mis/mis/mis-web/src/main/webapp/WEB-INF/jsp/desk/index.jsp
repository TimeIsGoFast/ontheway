			...
			<div class="c8">
				<div style="overflow: hidden;margin: 0 auto;">
					...
					<div style="overflow:hidden;margin:0 auto;width:95%;max-width:1800px;padding-top: 50px;">
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"><a href=""><img class="img-responsive" src="${pageContext.request.contextPath}/static/desk/img/p1-06.png"/></a></div>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"><a href=""><img class="img-responsive" src="${pageContext.request.contextPath}/static/desk/img/p1-07.png"/></a></div>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"><a href=""><img class="img-responsive" src="${pageContext.request.contextPath}/static/desk/img/p1-08.png"/></a></div>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"><a href=""><img class="img-responsive" src="${pageContext.request.contextPath}/static/desk/img/p1-09.png"/></a></div>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"><a href=""><img class="img-responsive" src="${pageContext.request.contextPath}/static/desk/img/p1-10.png"/></a></div>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"><a href=""><img class="img-responsive" src="${pageContext.request.contextPath}/static/desk/img/p1-11.png"/></a></div>			
					</div>
					<span class="btn">查看更多&nbsp;<i class="glyphicon glyphicon-arrow-right"></i></span>
				</div>				
			</div>
